...
//                             <th className=" p-2" style={{ border: 'none' }} >1.20</th>
//                             <th className=" p-2" style={{ border: 'none' }} >1.40</th>
//                             <th className=" p-2" style={{ border: 'none' }} >1.80</th>
//                             <th className=" p-2" style={{ border: 'none' }} >1.160</th>
//                             <th className=" p-2" style={{ border: 'none' }} >1.320</th>
//                         </tr>
//                     </thead>
//                     <tbody>
//                         {/* {data.map((test, rowIndex) => (
