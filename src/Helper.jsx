...
export const setInitialTestDetail = (f) => {
  ...
  if (f.includes("complete blood count") || f.includes("cbc")) {
    ...
    { testName: 'Monocytes', result: '', units: '%', bioRefInterval: '2-8' },
    { testName: 'Granulyocytes', result: '', units: '%', bioRefInterval: '48-81' },
    { testName: 'Eosinophils', result: '', units: '%', bioRefInterval: '1-6' },
    { testName: 'Basophil', result: '', units: '%', bioRefInterval: '0-1' },
